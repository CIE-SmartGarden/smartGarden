...
class HX711:
    ...
    def tare_A(self, times=15):
        ...
        backupReferenceUnit = -423.3  #BOSSSSSSSSSSSSSSSSS
        backupReferenceUnit = self.get_reference_unit_A()
        self.set_reference_unit_A(1)
        
#         value = self.read_average(times)
        value = 15143.333333333334    #BOSSSSSSSSSSSSSSSSS
        ...
        print("tare_A value = ", value)
        print("tare_A backupRef = ", backupReferenceUnit)
